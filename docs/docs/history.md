...
- AI features: Create/Load personality and talk to your VRM (**companion runtime**, parallel apps — **not** merged): **[Companion](https://github.com/AlfaOmegaGrafx/chat)** (self-hosted WebXR + VRM + voice + AI model settings); **optional [AIRI](https://github.com/AlfaOmegaGrafx/airi)** for extended companion depth — export/handoff/shared config from OpenNexus3DStudio only
